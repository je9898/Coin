    ...
    <div class="col-md-9 grid-margin stretch-card" style="padding-right: 0.05rem; !important; padding-left: 0.05rem; !important;">
      ...
      <div class="col-12">
        ...
        <div class="row mt-4" >
          ...
          <!-- Personal Sell -->
          <div class="col-md-6 stretch-card grid-margin" style="align-content: center !important;"  v-for="index in plus">
            <div class="card">
              <div class="card-body" :style="'font-weight: 600; border: 2px solid #' + personalStyle">
                <h4 class="card-title" style="font-weight: 600">Hedge Mode</h4>
                <form class="forms-sample mt-4">
                  <div class="form-group">
          ...
          <!-- Kimchi -->
          <div class="col-md-6 grid-margin stretch-card" style="align-content: center !important;">
            <div class="card">
              <div class="card-body" :style="'font-weight: 600; border: 2px solid #' + kimchiStyle" style="font-weight: 600">
                ...
                <form class="forms-sample mt-4">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" v-model="kimchiBids" style="text-align: right" placeholder="희망 매수 %">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group mt-5">
                    ...
                    <!--  전체 보유 개수 반영되도록  -->
                    <input type="text" class="form-control" style="text-align: right" v-model="kimchiAsks" placeholder="희망 매도 %">
                  </div>
                  <div class="form-group">
...
export default defineComponent({
  ...
  data() {
    return {
      ...
      plus : parseInt(localStorage.getItem("plus")) || 1, // 그물 추가
  ...
  methods: {
    ...
    async listSet() {
      ...
      await axios.post('/api/personalTradeList', param)
          .then(res => {
            ...
            if(this.personalTradeList.length === 0){
              selectData = false;
            }
          })
          .catch(function (error) {
      ...
      await axios.post('/api/kimchiSelect', param)
          .then(res => {
            ...
            if(this.kimchiTradeList.length === 0){
              selectData = false;
            }
          })
          .catch(function (error) {
    ...
    //김치 가격 가쥬와
    async kimchiPrice() {
      await axios.get("https://m.search.naver.com/p/csearch/content/qapirender.nhn?key=calculator&pkid=141&q=%ED%99%98%EC%9C%A8&where=m&u1=keb&u6=standardUnit&u7=0&u3=USD&u4=KRW&u8=down&u2=1")
          .then(res => {
            ...
            document.querySelectorAll(".order-book-tr").forEach(function (e){
              e.style.border = "";
            })

            if(document.querySelector("#bd-" + this.USDTPrice) !== null){
              document.querySelector("#bd-" + this.USDTPrice).style.border = "3px solid red";
            }
